    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    The countdown is over my Babu... Let's celebrate! 🎉
                </motion.p>
            </motion.div>
...
>
  <button
    onClick={() => {
      // Play music
      const audio = new Audio("https://files.catbox.moe/j8fkk5.mp3"); // replace with your mp3 link
      audio.play();

      // Trigger confetti
      confetti({ particleCount: 50, spread: 70, origin: { y: 0.6 } });

      // Call your existing onNext function
      onNext();
    }}
  ...
  >
    <motion.div className="flex items-center space-x-2" whileTap={{ scale: 0.95 }}>
      ...
      <Sparkles className="w-5 h-5" />
            ...
            >
                <p className="text-purple-300 text-base">Click to start the special magic! ✨</p>
            </motion.div>
        </motion.div>
    )
}
